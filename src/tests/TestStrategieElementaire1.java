...
public class TestStrategieElementaire1 {

    /**
    * Execute la strategie elemetaire 1 
    * @param args
    * @throws Exception
    */
	public static void main(String[] args) throws Exception {
        ...
        simulateur.ajouteEvenement(new LancerStrategie(date, new ChefPompierElementaire(simulateur), simulateur));
