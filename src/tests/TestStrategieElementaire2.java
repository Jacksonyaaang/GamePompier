...
public class TestStrategieElementaire2 {

    
    /**
    * Execute la strategie elemetaire 2 
    * @param args
    * @throws Exception
    */
    public static void main(String[] args) throws Exception {    
        ...
        simulateur.ajouteEvenement(new LancerStrategie(date, new ChefPompierElementaire2(simulateur), simulateur));
